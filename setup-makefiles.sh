...
(cat << EOF) > ../../../$OUTDIR/vibrantmtd-vendor-blobs.mk
...
for FILE in `cat proprietary-files.txt | grep -v ^# | grep -v ^$`; do
    ...
    echo "    $OUTDIR/proprietary/$FILE:system/$FILE$LINEEND" >> ../../../$OUTDIR/vibrantmtd-vendor-blobs.mk
done
...
DEVICE_PACKAGE_OVERLAYS := vendor/__VENDOR__/aries-common/overlay
